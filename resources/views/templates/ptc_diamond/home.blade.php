                        ...
                        @forelse ($posts as $post)
                            <div class="col-lg-3 col-md-6">
                                <article class="post-grid mb-5">
                                    ...
                                    <span class="cat-name text-color font-extra text-sm text-uppercase letter-spacing-1">By
                                    ...
                                    <span class="text-muted letter-spacing text-uppercase font-sm">
                                        {{ showDateTime($post->created_at, 'j F Y') }}</span>

                                </article>
                            </div>
                        @empty
                            <p class="text-center">There is no post in this blog</p>
                        @endforelse
                    </div>
                </div>
