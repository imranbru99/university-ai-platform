            ...
            <div class="row g-4 justify-content-between align-items-center">
                <div class="col-lg-12">
                    <div class="login-form">
                        ...
                        <h3 class="text-center">Register as PHD Writer</h3>
                        <form action="{{ route('user.register') }}" class="row g-3 g-xxl-4 verify-gcaptcha" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="username" id="username" placeholder="@lang('Username')"
                                    class="form-control form--control checkUser" value="{{ old('username') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" id="password_confirmation" name="password_confirmation"
                                    class="form-control form--control" placeholder="@lang('Re-type Password')" required>
                            </div>

                            <div class="col-12">
                                <button type="submit"
                                    class="btn btn--lg btn--base w-100 rounded">@lang('Register Now')</button>
                            </div>

                            <div class="col-12">
                                <p class="m-0 sm-text text-center lh-1">
                                    @lang('Already an Account ?')' <a href="{{ route('user.login') }}"
