            ...
            <div class="row g-4 justify-content-between align-items-center">
                <div class="col-lg-12">
                    <div class="login-form">
                        ...
                        <h3 class="text-center">Login as PHD Writer</h3>
                        <form action="{{ route('user.login') }}" class="row g-3 g-xxl-4 verify-gcaptcha" method="post">
                            ...
                            <div class="col-12">
                                ...
                                <input type="username" id="username" name="username" class="form-control form--control"
                            ...
                            <div class="col-12">
                                <button type="submit"
                                    class="btn btn--lg btn--base w-100 rounded">@lang('Login Now')</button>
                            </div>

                            <div class="col-12">
                                <p class="m-0 sm-text text-center lh-1">
                                    @lang('Don`t have an account?')' <a href="{{ route('user.register') }}"
                                        class="t-link t-link--base text--base">@lang('Create an Account')</a>
                                </p>
                            </div>
                        </form>
