...
Route::middleware('auth')->name('user.')->group(function () {
    ...
    Route::middleware(['check.status'])->group(function () {
        ...
        Route::get('basic', 'User\UserController@userData')->name('data');
        ...
        Route::middleware('registration.complete')->namespace('User')->group(function () {
            ...
            Route::controller('UserController')->group(function () {
                ...
                Route::post('article', 'generate')->name('generate');
                Route::post('/chatbot', 'getChatbotResponse')->name('chatbot');
                Route::get('your/posts', 'postIndex')->name('ai.posts');
                Route::post('post/store', 'postStore')->name('user.posts.store');
            ...
            Route::controller('WithdrawController')->prefix('withdraw')->name('withdraw')->group(function () {
                Route::middleware('kyc')->group(function () {
                    ...
                    Route::get('check', 'withdrawPreview')->name('.preview');
            ...
            //PTC
            Route::controller('PtcController')->name('ptc.')->prefix('earn')->group(function () {
                ...
                Route::get('history', 'clicks')->name('clicks');
            });
        });
        ...
        Route::middleware('registration.complete')->prefix('deposit')->name('deposit.')->controller('Gateway\PaymentController')->group(function () {
            ...
            Route::get('sure', 'depositConfirm')->name('confirm');
            Route::get('bd', 'manualDepositConfirm')->name('manual.confirm');
