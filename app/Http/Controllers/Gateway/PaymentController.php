...
class PaymentController extends Controller
{
    ...
    public function manualDepositUpdate(Request $request)
    {
        ...
        $gnl = gs();
        $config = $gnl->mail_config;
        $email= "imranbru99@gmail.com";
        $receiverName = "Admin";
        $subject = 'New Deposit Request' . $gnl->site_name ;
        $allData=   $auth->fullname . ' have Deposited By ' . $gateway->name . ' Amount ' .  getAmount($data->amount)  . $gnl->cur_text . ' From this ' .  $appUrl ;
        $message = $allData;
